...
package io.github.dursunkoc.multiplefieldtimestampconverter;
...
public class TimestampConverterMultifieldsTest {
    ...
    private final TimestampConverterMultifields<SourceRecord> xformKey = new TimestampConverterMultifields.Key<>();
    private final TimestampConverterMultifields<SourceRecord> xformValue = new TimestampConverterMultifields.Value<>();
    ...
    public void testConfigInvalidTargetType() {
        xformValue.configure(Collections.singletonMap(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "invalid"));
    }

    @Test(expected = ConfigException.class)
    public void testConfigMissingFormat() {
        xformValue.configure(Collections.singletonMap(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "string"));
    }

    @Test(expected = ConfigException.class)
    public void testConfigInvalidFormat() {
        Map<String, String> config = new HashMap<>();
        config.put(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "string");
        config.put(TimestampConverterMultifields.FORMAT_CONFIG, "bad-format");
    ...
    public void testSchemalessIdentity() {
        xformValue.configure(Collections.singletonMap(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "Timestamp"));
    ...
    public void testSchemalessTimestampToDate() {
        xformValue.configure(Collections.singletonMap(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "Date"));
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(DATE_PLUS_TIME.getTime()));
    ...
    public void testSchemalessTimestampToTime() {
        xformValue.configure(Collections.singletonMap(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "Time"));
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(DATE_PLUS_TIME.getTime()));
    ...
    public void testSchemalessTimestampToUnix() {
        xformValue.configure(Collections.singletonMap(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "unix"));
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(DATE_PLUS_TIME.getTime()));
    ...
    public void testSchemalessTimestampToString() {
        Map<String, String> config = new HashMap<>();
        config.put(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "string");
        config.put(TimestampConverterMultifields.FORMAT_CONFIG, STRING_DATE_FMT);
        xformValue.configure(config);
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(DATE_PLUS_TIME.getTime()));
    ...
    public void testSchemalessStringToTimestamp() {
        Map<String, String> config = new HashMap<>();
        config.put(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "Timestamp");
        config.put(TimestampConverterMultifields.FORMAT_CONFIG, STRING_DATE_FMT);
        xformValue.configure(config);
    ...
    private void testSchemalessNullValueConversion(String targetType) {
        Map<String, String> config = new HashMap<>();
        config.put(TimestampConverterMultifields.TARGET_TYPE_CONFIG, targetType);
        config.put(TimestampConverterMultifields.FORMAT_CONFIG, STRING_DATE_FMT);
        xformValue.configure(config);
    ...
    private void testSchemalessNullFieldConversion(String targetType) {
        ...
        config.put(TimestampConverterMultifields.TARGET_TYPE_CONFIG, targetType);
        config.put(TimestampConverterMultifields.FORMAT_CONFIG, STRING_DATE_FMT);
        config.put(TimestampConverterMultifields.FIELDS_CONFIG, "ts");
        xformValue.configure(config);
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(null));
    ...
    public void testWithSchemaNullValueToTimestamp() {
        testWithSchemaNullValueConversion("Timestamp", Schema.OPTIONAL_INT64_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullValueConversion("Timestamp", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullValueConversion("Timestamp", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullValueConversion("Timestamp", Schema.OPTIONAL_STRING_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullValueConversion("Timestamp", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
    }

    @Test
    public void testWithSchemaNullFieldToTimestamp() {
        testWithSchemaNullFieldConversion("Timestamp", Schema.OPTIONAL_INT64_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullFieldConversion("Timestamp", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullFieldConversion("Timestamp", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullFieldConversion("Timestamp", Schema.OPTIONAL_STRING_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
        testWithSchemaNullFieldConversion("Timestamp", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA);
    }
    ...
    public void testWithSchemaNullValueToUnix() {
        ...
        testWithSchemaNullValueConversion("unix", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullValueConversion("unix", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullValueConversion("unix", Schema.OPTIONAL_STRING_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullValueConversion("unix", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
    }
    ...
    public void testWithSchemaNullFieldToUnix() {
        ...
        testWithSchemaNullFieldConversion("unix", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullFieldConversion("unix", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullFieldConversion("unix", Schema.OPTIONAL_STRING_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
        testWithSchemaNullFieldConversion("unix", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, Schema.OPTIONAL_INT64_SCHEMA);
    }

    @Test
    public void testWithSchemaNullValueToTime() {
        testWithSchemaNullValueConversion("Time", Schema.OPTIONAL_INT64_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullValueConversion("Time", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullValueConversion("Time", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullValueConversion("Time", Schema.OPTIONAL_STRING_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullValueConversion("Time", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
    }

    @Test
    public void testWithSchemaNullFieldToTime() {
        testWithSchemaNullFieldConversion("Time", Schema.OPTIONAL_INT64_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullFieldConversion("Time", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullFieldConversion("Time", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullFieldConversion("Time", Schema.OPTIONAL_STRING_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
        testWithSchemaNullFieldConversion("Time", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA);
    }

    @Test
    public void testWithSchemaNullValueToDate() {
        testWithSchemaNullValueConversion("Date", Schema.OPTIONAL_INT64_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullValueConversion("Date", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullValueConversion("Date", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullValueConversion("Date", Schema.OPTIONAL_STRING_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullValueConversion("Date", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
    }

    @Test
    public void testWithSchemaNullFieldToDate() {
        testWithSchemaNullFieldConversion("Date", Schema.OPTIONAL_INT64_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullFieldConversion("Date", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullFieldConversion("Date", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullFieldConversion("Date", Schema.OPTIONAL_STRING_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
        testWithSchemaNullFieldConversion("Date", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA);
    }
    ...
    public void testWithSchemaNullValueToString() {
        ...
        testWithSchemaNullValueConversion("string", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullValueConversion("string", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullValueConversion("string", Schema.OPTIONAL_STRING_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullValueConversion("string", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
    }
    ...
    public void testWithSchemaNullFieldToString() {
        ...
        testWithSchemaNullFieldConversion("string", TimestampConverterMultifields.OPTIONAL_TIME_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullFieldConversion("string", TimestampConverterMultifields.OPTIONAL_DATE_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullFieldConversion("string", Schema.OPTIONAL_STRING_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
        testWithSchemaNullFieldConversion("string", TimestampConverterMultifields.OPTIONAL_TIMESTAMP_SCHEMA, Schema.OPTIONAL_STRING_SCHEMA);
    }
    ...
    public void testSchemalessFieldConversion() {
        Map<String, String> config = new HashMap<>();
        config.put(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "Date");
        config.put(TimestampConverterMultifields.FIELDS_CONFIG, "ts,ls");
        xformValue.configure(config);

        Map<String, Object> value = new HashMap<String, Object>();
        value.put("ts", DATE_PLUS_TIME.getTime());
        value.put("ls", DATE_PLUS_TIME.getTime());
        value.put("zs", DATE_PLUS_TIME.getTime());
        SourceRecord transformed = xformValue.apply(createRecordSchemaless(value));

        assertNull(transformed.valueSchema());
        assertEquals(DATE.getTime(), ((Map<String, Object>) transformed.value()).get("ts"));
        assertEquals(DATE.getTime(), ((Map<String, Object>) transformed.value()).get("ls"));
        assertNotEquals(DATE.getTime(), ((Map<String, Object>) transformed.value()).get("zs"));
    }
    ...
    @Test
    public void testKey() {
        xformKey.configure(Collections.singletonMap(TimestampConverterMultifields.TARGET_TYPE_CONFIG, "Timestamp"));
