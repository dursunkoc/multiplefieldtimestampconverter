...
public abstract class TimestampConverterMultifields<R extends ConnectRecord<R>> implements Transformation<R> {
    ...
    public static final String OVERVIEW_DOC =
            "Convert timestamps between different formats such as Unix epoch, strings, and Connect Date/Timestamp types."
                    ...
                    + "<p/>Use the concrete transformation type designed for the record key (<code>" + TimestampConverterMultifields.Key.class.getName() + "</code>) "
                    + "or value (<code>" + TimestampConverterMultifields.Value.class.getName() + "</code>).";

    public static final String FIELDS_CONFIG = "fields";
    private static final String FIELDS_DEFAULT = "";
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
            .define(FIELDS_CONFIG, ConfigDef.Type.LIST, Collections.emptyList(), ConfigDef.Importance.HIGH,
                    "Fields containing the timestamp, or empty if the entire value is a timestamp")
    ...
    private static class Config {
        Config(List<String> fields, String type, SimpleDateFormat format) {
            this.fields = fields;
            this.type = type;
            this.format = format;
        }
    ...
    public void configure(Map<String, ?> configs) {
        ...
        final List<String> fields = simpleConfig.getList(FIELDS_CONFIG);
    ...
    public static class Key<R extends ConnectRecord<R>> extends TimestampConverterMultifields<R> {
        @Override
    ...
    public static class Value<R extends ConnectRecord<R>> extends TimestampConverterMultifields<R> {
        @Override
        protected Schema operatingSchema(R record) {
    ...
    private R applySchemaless(R record) {
        ...
        if (rawValue == null || config.fields.isEmpty()) {
            ...
            config.fields.forEach(f->updatedValue.put(f, convertTimestamp(value.get(f))));
